...
public class JenkinsJenkinsServiceApiImplTest {
    ...
    public void before() {
        ...
        jobConfig.setCodeUrl("http://192.168.101.94/cloudzone/autotest.git/");
        jobConfig.setBaseImage("192.168.101.90/cloudzone/alpine-sunjdk8:151");
        jobConfig.setImageUser("gc-cloud");
        jobConfig.setImageName("autotest:3.2");
        jobConfig.setRepositoryUrl("192.168.101.90");
